...
import 'account_provider_selector.dart';
...
class _AddressAddScreenState extends State<AddressAddScreen> {
  ...
  Future<void> _navigateToManualSettings(
    ...
    final result = await ModelBottomSheetHelper.showModalBottomSheet(
      context,
      localizations.text('accountProviderStepTitle'),
  ...
  Widget build(BuildContext context) {
    ...
    return Base.buildAppChrome(
      context,
      title: localizations.text('addAccountTitle'),
      content: Column(
        children: [
          Expanded(
            child: Stepper(
  ...
  Future _discover(String email) async {
    ...
    final provider = await providerService.discover(email);
    if (!mounted) {
  ...
  Step _buildEmailStep(BuildContext context, AppLocalizations localizations) {
    return Step(
      title: _currentStep == 0
          ? Text(localizations.text('addAccountEmailLabel'))
          : Column(
        ...
        children: [
          DecoratedPlatformTextField(
            ...
            decoration: InputDecoration(
              labelText: localizations.text('addAccountEmailLabel'),
              hintText: localizations.text('addAccountEmailHint'),
  ...
  Step _buildPasswordStep(
    ...
    return Step(
      title: Text(localizations.text('addAccountPasswordLabel')),
      ...
      content: Column(
              ...
              children: [
                ...
                Expanded(
                  child: Text(localizations
                      .text('addAccountResolvingSettingsLabel')),
                ),
              ],
            )
            ...
            Column(
              children: [
                if (provider.hasOAuthClient) ...[
                  ...
                  Text(
                    localizations.text('addAccountOauthOptionsText'),
                  ),
                  FittedBox(
                  ...
                  if (appSpecificPasswordSetupUrl != null) ...[
                    Padding(
                      ...
                      child: Text(
                          localizations.text('addAccountOauthSignInWithAppPassword')),
                    ),
                    TextButton(
                      onPressed: () async {
                        await launcher
                      ...
                      child: ButtonText(localizations
                          .text('addAccountApplicationPasswordRequiredButton')),
                    ),
                    CheckboxListTile(
        ...
        .text('addAccountApplicationPasswordRequiredAcknowledged')),
                    ),
                  ],
                ] else if (provider.appSpecificPasswordSetupUrl != null) ...[
                  Text(localizations.text('addAccountApplicationPasswordRequiredInfo')),
                  TextButton(
                    onPressed: () async {
                ...
                if (provider.appSpecificPasswordSetupUrl == null ||
                  ...
                  PasswordField(
                    ...
                    autofocus: true,
                    labelText: localizations.text('addAccountPasswordLabel'),
                    hintText: localizations.text('addAccountPasswordHint'),
                  ),
                TextButton(
                  onPressed: () =>
                      _navigateToManualSettings(context, localizations),
                  child: Text(
                    localizations.text('addAccountResolvedSettingsWrongAction')),
                  ),
                ),
                if (_extensionForgotPassword != null) ...[
                  TextButton(
                    ...
                    child: Text('_extensionForgotPassword!'),
                  ),
                ],
              ],
            )
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(localizations.text('addAccountResolvingSettingsFailedInfo')),
                ElevatedButton(
                  child: ButtonText(localizations.text('addAccountEditManuallyAction')),
                  onPressed: () =>
                      _navigateToManualSettings(context, localizations),
                )
              ],
  ...
  Step _buildAccountSetupStep(
    ...
    return Step(
      title: Text(_isAccountVerified
          ? localizations.text('addAccountSetupAccountStep')
          : localizations.text('addAccountVerificationStep')),
      content: Column(
        mainAxisSize: MainAxisSize.max,
        children: [
          if (_isAccountVerifying)
            Row(
              children: [
                ...
                Expanded(
                  child: Text(localizations
                      .text('addAccountVerifyingSettingsLabel')),
                ),
              ],
            )
          else if (_isAccountVerified) ...[
            Text(localizations.text('addAccountVerifyingSuccessInfo')),
            DecoratedPlatformTextField(
              ...
              decoration: InputDecoration(
                labelText: localizations.text('addAccountNameOfUserLabel'),
                hintText: localizations.text('addAccountNameOfUserHint'),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: localizations.text('addAccountNameOfAccountLabel'),
                hintText: localizations.text('addAccountNameOfAccountHint'),
                icon: const Icon(Icons.email),
              ),
              cupertinoAlignLabelOnTop: true,
            ),
            ...
            Text(localizations
                .text('addAccountVerifyingFailedInfo')),
            if (_provider?.manualImapAccessSetupUrl != null) ...[
              Padding(
                padding: const EdgeInsets.only(top: 8.0, bottom: 8.0),
                child: Text(
                    localizations.text('accountAddImapAccessSetupMightBeRequired')),
              ),
              TextButton(
                child: Text(
                    localizations.text('addAccountSetupImapAccessButtonLabel')),
                onPressed: () => launcher
