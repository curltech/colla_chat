...
/// 大模型聊天界面
class LlmChatMessageView extends StatefulWidget with TileDataMixin {
  ...
  State<StatefulWidget> createState() {
    return _LlmChatMessageViewState();
  }
...
class _LlmChatMessageViewState extends State<LlmChatMessageView> {
  final ValueNotifier<ChatSummary?> _chatSummary =
      ValueNotifier<ChatSummary?>(llmChatMessageController.chatSummary);
  ...
  void initState() {
    super.initState();
    llmChatMessageController.addListener(_updateChatMessage);
  ...
  _updateChatMessage() {
    if (_chatSummary.value != llmChatMessageController.chatSummary) {
      _chatSummary.value = llmChatMessageController.chatSummary;
    ...
    final Widget chatMessageView = ValueListenableBuilder(
        ...
        builder: (BuildContext context, double value, Widget? child) {
          ...
          Widget chatMessageWidget =
              SizedBox(height: height, child: widget.llmChatMessageWidget);
          return VisibilityDetector(
              ...
              child: KeyboardActions(
                  ...
                  child: Column(children: <Widget>[
                    ...
                    widget.llmChatMessageInputWidget
                  ])));
        });
  ...
  @override
  void dispose() {
    llmChatMessageController.removeListener(_updateChatMessage);
