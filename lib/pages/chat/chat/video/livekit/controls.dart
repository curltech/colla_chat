...
class _ControlsWidgetState extends State<ControlsWidget> {
  ...
  void _unpublishAll() async {
    final result = await showUnPublishDialog();
  ...
  void _onTapUpdateSubscribePermission() async {
    final result = await showSubscribePermissionDialog();
    if (result != null) {
      try {
  ...
  Future<SimulateScenarioResult?> showSimulateScenarioDialog() async {
    return await showDialog<SimulateScenarioResult>(
      context: context,
  ...
  void _onTapSimulateScenario() async {
    final result = await showSimulateScenarioDialog();
    if (result != null) {
      print('${result}');
  ...
  void _onTapSendData() async {
    final result = await showSendDataDialog();
    if (result == true) {
