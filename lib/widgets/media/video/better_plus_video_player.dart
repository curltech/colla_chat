...
///基于better plus实现的媒体播放器和记录器，
class BetterPlusVideoPlayerController extends AbstractMediaPlayerController {
  ...
  BetterPlusVideoPlayerController(super.playlistController);
