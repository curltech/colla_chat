...
///基于better enhance实现的媒体播放器和记录器，
class BetterEnhanceVideoPlayerController extends AbstractMediaPlayerController {
  ...
  BetterEnhanceVideoPlayerController(super.playlistController);
