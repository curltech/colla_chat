...
chat就可以采用这种方式
*/
var PingAction = /** @class */ (function (_super) {
    __extends(PingAction, _super);
    function PingAction(msgType) {
        return _super.call(this, msgType) || this;
    }
    PingAction.prototype.ping = function (connectPeerId, data, targetPeerId) {
...
exports.pingAction = new PingAction(message_1.MsgType.PING);
