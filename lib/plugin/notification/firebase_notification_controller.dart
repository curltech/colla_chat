...
///firebase remote awesome通知控制器
class FirebaseNotificationController with ChangeNotifier {
  /// *********************************************
  ///   SINGLETON PATTERN
  /// *********************************************

  static final FirebaseNotificationController _instance =
      FirebaseNotificationController._internal();

  factory FirebaseNotificationController() {
    return _instance;
  }
  ...
  static Future<void> initializeRemoteNotifications(
    ...
    await AwesomeNotificationsFcm().initialize(
        onFcmSilentDataHandle:
            FirebaseNotificationController.mySilentDataHandle,
        onFcmTokenHandle: FirebaseNotificationController.myFcmTokenHandle,
        onNativeTokenHandle: FirebaseNotificationController.myNativeTokenHandle,
        licenseKeys:
  ...
  static Future<void> initializeNotificationListeners() async {
    ...
    await AwesomeNotifications().setListeners(
        onActionReceivedMethod:
            FirebaseNotificationController.myActionReceivedMethod,
        onNotificationCreatedMethod:
            FirebaseNotificationController.myNotificationCreatedMethod,
        onNotificationDisplayedMethod:
            FirebaseNotificationController.myNotificationDisplayedMethod,
        onDismissActionReceivedMethod:
            FirebaseNotificationController.myDismissActionReceivedMethod);
  }
