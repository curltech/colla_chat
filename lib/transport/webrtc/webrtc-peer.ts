...
export class WebrtcPeer {
  ...
  init(targetPeerId: string, iceServer: [],
    ...
    if (!iceServer) {
      iceServer = config.appParams.iceServers[0]
    }
     ...
     * 可以发起信号
     */
    this._webrtcPeer.on('signal', async (data: any) => {
